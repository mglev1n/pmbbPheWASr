...
The goal of `pmbbPheWASr` is to enable Penn Medicine Biobank researchers to perform phenome-wide association studies (PheWAS) using Penn Medicine Biobank data. This package provides a set of tools to perform PheWAS analyses, including data cleaning, harmonization, and analysis.
